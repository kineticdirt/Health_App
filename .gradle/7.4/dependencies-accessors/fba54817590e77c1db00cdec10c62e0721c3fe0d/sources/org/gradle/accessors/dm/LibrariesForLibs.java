...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final FragLibraryAccessors laccForFragLibraryAccessors = new FragLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at frag
     */
    public FragLibraryAccessors getFrag() { return laccForFragLibraryAccessors; }
    ...
    public static class FragLibraryAccessors extends SubDependencyFactory {

        public FragLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for nav (com.ncapdevi:frag-nav)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getNav() { return create("frag.nav"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: fragNav (3.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFragNav() { return getVersion("fragNav"); }
